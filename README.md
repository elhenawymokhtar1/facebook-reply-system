# 🤖 نظام إدارة الرسائل والألوان الذكي

نظام ذكي متكامل لإدارة رسائل Facebook Messenger مع إرسال صور المنتجات تلقائياً بناءً على الألوان المطلوبة باستخدام الذكاء الاصطناعي.

## 🎯 نظرة عامة

هذا النظام يجمع بين قوة الذكاء الاصطناعي (Google Gemini) وتكامل Facebook Messenger لتوفير تجربة تسوق تفاعلية ذكية. عندما يطلب العميل لوناً معيناً، يرد النظام تلقائياً بصورة المنتج المطلوب.
...
- 📊 **إحصائيات وتحليلات** للرسائل والمحادثات
...
# تشغيل خادم API (في terminal منفصل)
npm run api
```
...
#### **إضافة لون جديد:**
1. اذهب إلى صفحة **إدارة صور المنتجات**
2. في تبويب **🎨 الألوان المتاحة**
3. اضغط **إضافة لون بسيط**
4. أدخل:
   - **اسم اللون بالعربية** (مثل: أحمر)
   - **اسم اللون بالإنجليزية** (مثل: Red)
   - **رابط الصورة** (HTTPS مطلوب)
...
### ملفات البيانات:
- **`colors-data.json`** - ملف الألوان (ينشأ تلقائياً)
